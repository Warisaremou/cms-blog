export const postQueries = () => {
	...
	const ADD_POST_WITH_IMAGE =  `INSERT INTO posts(title, image, content, id_user) VALUES (?, ?, ?, ?)`;
	
	const ADD_POST_WITHOUT_IMAGE =  `INSERT INTO posts(title, content, id_user) VALUES (?, ?, ?)`;
